...
public class BinarySearchTree<E> {
    BinaryNode<E> root; // Root node of the binary search tree
    ...
    private BinaryNode<E> buildTree(ArrayList<E> sorted, int first, int last) {
        // Base case: If the starting index is greater than the ending index, the sublist is empty
        if (first > last)
        ...
        // Create a new node with the element at the middle index as the root of the current subtree
